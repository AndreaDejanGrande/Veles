...
extern int scanhash_neovcrypt(int thr_id, struct work *work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_neovcrypt(int thr_id);
...
void neovcrypt(uchar *output, const uchar *input, uint32_t profile);
