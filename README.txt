...
its command line interface and options.
  ...
  -a, --algo=ALGO       specify the algorithm to use
                          vcrypt      use to mine vCrypt coins (vDinar)
                          vcrypt:N    use to mine adaptive vCrypt (:10 for 2048 iterations)
...
Example for vCrypt-N (2048) on Nicehash
    ccminer -a vcrypt:10 -o stratum+tcp://stratum.nicehash.com:3335 -u 3EujYFcoBzWvpUEvbe3obEG95mBuU88QBD -p x
