...
extern void cuda_vcrypt_HtoD(int thr_id, uint32_t *X, int stream);
extern void cuda_vcrypt_serialize(int thr_id, int stream);
extern void cuda_vcrypt_core(int thr_id, int stream, unsigned int N);
extern void cuda_vcrypt_done(int thr_id, int stream);
extern void cuda_vcrypt_DtoH(int thr_id, uint32_t *X, int stream, bool postSHA);
extern bool cuda_vcrypt_sync(int thr_id, int stream);
extern void cuda_vcrypt_flush(int thr_id, int stream);

// If we're in C++ mode, we're either compiling .cu files or vcrypt.cpp
