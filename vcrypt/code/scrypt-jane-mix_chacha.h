#if !defined(VCRYPT_CHOOSE_COMPILETIME) || !defined(VCRYPT_CHACHA_INCLUDED)

#undef VCRYPT_MIX
#define VCRYPT_MIX "ChaCha20/8 Ref"

#undef VCRYPT_CHACHA_INCLUDED
#define VCRYPT_CHACHA_INCLUDED
#define VCRYPT_CHACHA_BASIC
