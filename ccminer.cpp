...
struct option options[] = {
	...
	{ "no-autotune", 0, NULL, 1004 },  // vcrypt
	{ "interactive", 1, NULL, 1050 },  // vcrypt
	{ "lookup-gap", 1, NULL, 'L' },    // vcrypt
	{ "texture-cache", 1, NULL, 1051 },// vcrypt
	{ "launch-config", 1, NULL, 'l' }, // vcrypt bbr xmr
...
static char const vcrypt_usage[] = "\n\
vCrypt specific options:\n\
...
void parse_arg(int key, char *arg)
{
	...
	case 1050: /* vcrypt --interactive */
		...
		break;
	case 1051: /* vcrypt --texture-cache */
		{
			char *pch = strtok(arg,",");
			int n = 0, last = atoi(arg);
			while (pch != NULL) {
